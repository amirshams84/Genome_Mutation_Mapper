...
$element=1; 	  
 ...
 for($k=0;$k<10;$k++){
  ...
  imagestring($im,3,10,$k+40+$off,$seqname[$i],$black);//here we changed it to seqname for appearance of seq name beside 
	$off+=50;
	$element++;
 //}
 }
...
/* 
 ...
 $deltri = array($multi_del[$o][$p]+100-2,20+$off,$multi_del[$o][$p]+100+2,20+$off,$multi_del[$o][$p]+100,15+$off);
 ...
 */
 ...
 for($i=0;$i<10;$i++){
	 ...
	 //imageline($im,50,$i+150 ,1300,$i+150,$black);
	  ...
	  imagestring($im,3,10,$i+40+$off,"Reference ",$black);
  $j =0;
...
//////////////////////////////////////// 
//header('Content-Type: image/png');
imagepng($im,'./fasta_files/GMM2_Comparision_map'.'_NODELETION_'.$rand.'.png',PNG_NO_FILTER,0);
