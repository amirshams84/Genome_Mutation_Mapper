...
<input type="button" value="PHYLOGRAM VIEW" onclick='window.location.href="download_tree.php?file=<?php echo './fasta_files/GMM2_phylogram_'.$rand.'.tree';?>"'>
 <input type="button" value="SAVE IT WITH MAX QUALITY" onclick='window.location.href="png_save.php?file=<?php echo './fasta_files/GMM2_Comparision_map'.'_NODELETION_'.$rand.'.png';?>"'>
